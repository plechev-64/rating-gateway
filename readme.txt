...
= 1.1 =
появилась опция позволяющая отключать пополнение внутреннего баланса рейтингом

= 1.2 =
Повышена безопасность платежа рейтингом, появилась опция "Секретный ключ", 
которая участвует при формировании цифровой подписи платежа
